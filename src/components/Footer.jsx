...
const Footer = () => {
    return (
        <footer className="bg-[#f2f2f2] ">
            ...
            <div className="flex flex-col cursor-pointer md:flex-row justify-between py-3 md:py-0 md:px-[15px]">
                <div className="flex justify-center">
                    {quickLinks.map((menu, index) => (
                        <span
                            key={index}
                            className="text-[#70757a] hover:underline text-[12px] md:text-[14px] leading-none p-[10px] md:p-[15px]"
                        >
                            {menu}
                        </span>
                    ))}
